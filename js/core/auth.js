...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // =================================================
  // GUARD GLOBAL DE AUTENTICAí‡íƒO
  // =================================================
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        showLoginMessage("Login efetuado com sucesso! âœ…", "success");
  ...
  if (signupForm) {
    signupForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        showSignupMessage("Conta criada com sucesso! âœ…", "success");
        window.location.href = "./dashboard.html";
      } catch (err) {
  ...
  document.querySelectorAll(".toggle-password").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      if (iconUse) {
        ...
        // Resolve path according to current page
        iconUse.setAttribute(
          "href",
          `../assets/icons/icons-unified.svg#${iconName}`
        );
      }
    });
  });
