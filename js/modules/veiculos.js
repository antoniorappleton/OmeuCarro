...
async function carregarVeiculos() {
  ...
  veiculos.forEach((v) => {
    ...
    // ðŸ”¹ Calcular estados (Seguro, IPO, IUC)
    const now = new Date();
    // Helper para badge
      ...
      return `
        <div class="status-item ${statusClass}">
           ...
           <div class="status-value">
             <svg class="badge-icon"><use href="../assets/icons/icons-unified.svg#${icon}"></use></svg>
             <span>${text}</span>
           </div>
        </div>
      `;
          ...
          <div class="vehicle-avatar">
            ${
              v.fotoUrl
                ...
                : `<svg class="icon" aria-hidden="true"><use href="../assets/icons/icons-unified.svg#icon-car"></use></svg>`
            }
          </div>
                ...
                return `
                       <div style="margin-top:4px;">
                         <button class="btn-xs btn-outline-warning full-width" style="justify-content:center; gap:4px;" type="button" data-edit="${v.id}">
                            <svg class="icon-xs"><use href="../assets/icons/icons-unified.svg#icon-alert-triangle"></use></svg>
                            Atualizar km
                         </button>
                       </div>
                     `;
              ...
              ${
                ...
                <span class="badge badge-year">
                  <svg class="icon icon-badge" aria-hidden="true">
                    <use href="../assets/icons/icons-unified.svg#icon-calendar"></use>
                  </svg>
                  ${ano}
                </span>`
                  : ""
